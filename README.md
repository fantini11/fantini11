...
Estudante de Ciência da Computação na PUC Minas (4º período).

Tenho interesse em desenvolvimento de software, especialmente nas áreas de backend, bancos de dados e Inteligência Artificial — incluindo IA Generativa, LLMs e RAG.
...
- Banco de Dados
- Inteligência Artificial / IA Generativa / RAG
- Sistemas Web
